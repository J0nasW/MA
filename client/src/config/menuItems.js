...
import {
  ...
  AddBox as ContainerIcon,
  PostAdd as OrderIcon,
  Event as EventIcon,
  Vibration as DeviceIcon,
  ...
  return [
    {
      ...
      primaryText: intl.formatMessage({ id: 'locales_home' }),
      leftIcon: <DashboardIcon />,
    },
    {
      value: '/containers',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_container' }),
      leftIcon: <ContainerIcon />,
    },
    {
      value: '/orders',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_order' }),
      leftIcon: <OrderIcon />,
    },
    {
      value: '/events',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_events' }),
      leftIcon: <EventIcon />,
    },
...

    {
      value: '/devices',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_devices' }),
      leftIcon: <DeviceIcon />,
    },
    {
      value: '/map',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_map' }),
      leftIcon: <MapIcon />,
    },
    {
      value: '/status',
      visible: isAuthorised,
      primaryText: intl.formatMessage({ id: 'locales_status' }),
      leftIcon: <StatusIcon />,
    },
